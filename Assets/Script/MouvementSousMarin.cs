...
public class ControleAraigneeV2 : MonoBehaviour
{
    ...
    void OnDirections(InputValue directionBase)
    {
        ...
        directionInput = new Vector3(directionAvecVitesse.x, directionAvecVitesse.x, directionAvecVitesse.y);
        _animator.SetFloat("Transition", directionInput.magnitude);
    }
